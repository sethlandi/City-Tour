...
public class JdbcUserDao implements UserDao {
    ...
    public User saveUser(String userName, String password, String role) {
        ...
        long newId = jdbcTemplate.queryForObject(
                "INSERT INTO users(username, password, salt, role) VALUES (?, ?, ?, ?) RETURNING userid", Long.class,
    ...
    public List<User> getAllUsers() {
        ...
        String sqlSelectAllUsers = "SELECT userid, username, role FROM users";
    ...
    public User getUserByUsername(String username) {
        String sqlSelectUserByUsername = "SELECT userid, username, role FROM users WHERE username = ?";
